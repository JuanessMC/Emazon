...
class CategoryUseCaseTest {
    ...
    void getAllCategories_whenValidPaginationParameters() {
        // GIVEN
        Paginate<Category> expectedPaginatedCategories = PaginatedFactory.createPaginatedCategories();
        ...
        // WHEN
        Paginate<Category> result = categoryUseCase.getAllCategories(page, size, ascendingOrder);
    ...
    void getAllCategories_whenNoCategoriesAvailable() {
        // GIVEN
        Paginate<Category> emptyPaginatedCategories = PaginatedFactory.createPaginatedResult(Collections.emptyList(), 1, 10);
